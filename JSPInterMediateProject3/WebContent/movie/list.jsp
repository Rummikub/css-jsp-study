	...
	<div class="container">
				...
				<div class="col-md-4">
										   <div class="panel panel-danger">
										      ...
										      <div class="panel-body">
										      	<a href="detail.jsp?mno=${vo.mno }"><img src="${vo.poster }" width=280px height=220px></a>
										      </div>
										    </div>
										</div>
			</c:forEach>
			...
			<a href="list.jsp?page=${curpage>1?curpage-1:curpage }" class="btn btn-sm btn-primary">이전</a>
				${curpage  } page/ ${totalpage } pages
					<a href="list.jsp?page=${curpage<totalpage?curpage+1:curpage }" class="btn btn-sm danger">다음</a>
			</div>
