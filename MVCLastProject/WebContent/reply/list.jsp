...
<div class="wrapper row2">
  <div id="services" class="clear">
  	...
  	<div class="row">
  	 ...
  	 <table class="table">
  	 	...
  	 	<tr>
  	 	 ...
  	 	 <td width="45%" >
  	 	 	<c:if test="${vo.group_tab>0}"> <!--※답변이 있다면 -->
  	...
  	<div class="row text-center">
 		<a href="../reply/list.do?page=${curpage>1?curpage-1:curpage }" class="btn btn-sm btn-success">이전</a>
		${curpage} page/ ${totalpage} pages
 		<a href="../reply/list.do?page=${curpage<totalpage?curpage+1:curpage }" class="btn btn-sm btn-success">다음</a>
  	</div>
  </div>
</div>
</body>
